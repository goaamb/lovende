...
<div
	...
	<p style="margin: 0 0 15px">
		Se ha cerrado la disputa <?=$disputa?> por artículo no recibido de los siguientes artículos que le compraste a <a
	...
	<p>
		...
		<?=$vendedor->ciudad->nombre.", ". $vendedor->pais->nombre?><br />
	</p>
