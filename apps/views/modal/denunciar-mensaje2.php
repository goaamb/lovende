	...
	<div class="formA">
		<form action="" method="post" id="formDenunciaEnvio">
			...
			<div class="wrap">
				...
				<div class="line">
					<label for="">
						El mensaje privado sera eliminado de su bandeja
						<br/>
			...
			<footer>
				<p class="actions">
					<input type="hidden" name="idmensaje"
						value="<?=$idmensaje?>" /><input
						type="hidden" name="reportado"
						value="<?=$reportado->id?>" /> <input
...
<script type="text/javascript">
	$(function() {
 	 	$('.nmodal').nyroModal();
 	 	$("#formDenunciaEnvio").on("submit",function(){var x=formItemSubmit.call(this);if(x){enviarDenunciaMensaje.call(this)};return false;});
	});
</script>