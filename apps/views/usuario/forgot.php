<div class="wrapper clearfix">
	<header class="cont-cab mbl">
		<h1><?=traducir ( "¿Olvidaste tu contraseña?" )?></h1>
		<p><?=traducir ( "Te enviaremos un email con tu nueva
	...
	<div class="formB">
		...
		<p>
			<label for=""><?=traducir ( "Email con el que te registraste en Lovende:" )?></label>
			<input type="mail" class="texto w225" name="email"
				value="<?php echo set_value('email',($usuario?$usuario->email:"")); ?>" /> <?php print form_error("email") ;?>
		</p>
		<div class="ver-mas">
			<div class="clearfix registro-dual">
				<input type="submit" value="<?=traducir ( "Enviar" )?>" class="bt"
					name="olvidar" />
			</div>
		</div>
		</form>
