...
// Autoload text in GUI - If set to false, set values manually into the HTML
// file
var autoload = true;
...
var lang = 'php'; // options: php, jsp, lasso, asp, cfm, ashx, asp // we are
					// looking for contributors for lasso, python connectors
					// (partially developed)
...
am.pop();
am = am.join("/");
var fileRoot = '/' + am + '/files/documents/';
